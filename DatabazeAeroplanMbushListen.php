...
//{
    ...
    if($shtetiNisjes=="" || $shtetiDestinacionit=="")
    {
        ...
        echo "window.location='Aeroplani.php'";
        echo "</script>";
    }
    else
    {
   ...
   // $destinacioni=trim($_POST['shteti']);
    ...
    $sqlquery = "SELECT * from linjat where menyra_udhetimit='Aeroplan' and shteti_nisja like '".$shtetiNisjes."' and sh_destinacioni='".$shtetiDestinacionit."'";
