...
if($shtetiNisjes=="" || $shtetiDestinacionit=="")
{
    ...
    echo "window.location='Anije.php'";
    echo "</script>";
}
else
{
    ...
    $sqlquery = "SELECT * from linjat where menyra_udhetimit='Anije' and shteti_nisja like '%".$shtetiNisjes."%' and sh_destinacioni like '%".$shtetiDestinacionit."%'";
